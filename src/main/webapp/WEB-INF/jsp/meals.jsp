    ...
    <div class="container">
        ...
        <div class="card border-dark">
            ...
            <div class="card-footer text-right">
                ...
                <button class="btn btn-primary" onclick="updateByFilter()">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr data-mealExcess="${meal.excess}">
                    ...
                    <td><a class="delete"><span class="fa fa-remove" onclick="deleteRow(${meal.id})"></span></a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
                ...
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" id="dateTime" name="dateTime"
                               placeholder="Дата/Время" value="${meal.dateTime}">
                    </div>

                    <div class="form-group">
                        <label for="description" class="col-form-label"><spring:message code="meal.description"/>:</label>
                        <input type="text" class="form-control" id="description" name="description"
                               placeholder="Описание" value="${meal.description}">
                    </div>

                    <div class="form-group">
                        <label for="calories" class="col-form-label"><spring:message code="meal.calories"/>:</label>
                        <input type="number" class="form-control" id="calories" name="calories" placeholder="1000" value="${meal.calories}">
                    </div>
                </form>
            </div>
