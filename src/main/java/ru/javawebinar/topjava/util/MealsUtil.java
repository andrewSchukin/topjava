...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static Meal createNewFromToUI(MealToUI newMeal) {
        return new Meal(null, newMeal.getDateTime(), newMeal.getDescription(), newMeal.getCalories());
    }

    public static Meal updateFromToUI(Meal meal, MealToUI mealToUI) {
        meal.setDescription(mealToUI.getDescription());
        meal.setCalories(mealToUI.getCalories());
        meal.setDateTime(mealToUI.getDateTime());
        return meal;
    }
